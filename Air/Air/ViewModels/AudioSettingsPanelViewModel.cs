...
public partial class AudioSettingsPanelViewModel : BasePanelViewModel
{
    public AudioSettingsPanelViewModel(MainWindowViewModel mainWindowViewModel)
    ...
    private void EnsureStopAudioMonitoring()
    {
        if (IsMonitoringAudio)
            StopMonitoringAudio();
    }
    ...
    private void LoadAudioDevicesInfo()
    {
        OutputDevices.Clear();
